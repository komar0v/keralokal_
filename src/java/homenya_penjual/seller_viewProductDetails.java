        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("seller")) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("SELECT product_id,nama_produk,jenis_produk,keterangan_produk,stok_produk,harga_produk FROM tabel_produk WHERE inserted_by =? AND product_id=?");
                    String idProduk_ = request.getParameter("idProduk_");
                    ps.setString(1, idAkun);
                    ps.setString(2, idProduk_);

                    ResultSet rs = ps.executeQuery();
                    if (rs.next()) {
                        String idProd_STR = Integer.toString(rs.getInt("product_id"));

                        prdct_details.setId_produk(idProd_STR);
                        prdct_details.setNama_produk(rs.getString("nama_produk"));
                        prdct_details.setJenis_produk(rs.getString("jenis_produk"));
                        prdct_details.setKeterangan_produk(rs.getString("keterangan_produk"));
                        prdct_details.setStock_produk(rs.getInt("stok_produk"));
                        prdct_details.setHarga_produk(rs.getDouble("harga_produk"));
                    }
                    ...
                    try {
                        out.println("<!DOCTYPE html>\n"
                                ...
                                + "                                            <input name=\"jenisProduk\"type=\"text\" class=\"form-control\" id=\"exampleInputEmail1\" required placeholder=\"cth : pakaian\" value=\"" + prdct_details.getJenis_produk() + "\">\n"
                                + "                                        </div>\n"
                                + "                                        <div class=\"form-group\">\n"
                                ...
                                + "                                            <input name=\"stokProduk\"type=\"number\" min=\"1\" class=\"form-control\" required id=\"exampleInputEmail1\" value=\"" + prdct_details.getStock_produk() + "\">"
                                + "                                        &nbsp;&nbsp;&nbsp;<label >Harga Produk&nbsp; Rp.</label>\n"
                                + "                                            <input name=\"hargaProduk\"type=\"number\" min=\"1000\" class=\"form-control\" required id=\"exampleInputEmail1\" value=\"" + prdct_details.getHarga_produk() + "\">"
                                + "                                        </div><br>\n"
                                + "                                        <input name=\"idProduk\"type=\"text\" hidden value=\"" + prdct_details.getId_produk() + "\">"
                                + "                                        <button type=\"submit\" class=\"btn btn-primary\">SIMPAN PERUBAHAN</button>\n"
                                + "                                        <button type=\"reset\" class=\"btn btn-secondary\">RESET</button>\n"
                                + "                                        <button type=\"submit\" formaction=\"./seller_confirmHapusDataProduk?idProduk_="+prdct_details.getId_produk()+"\" class=\"btn btn-danger\">HAPUS DATA</button>\n"
                                + "                                    </form>"
                                + "                </div>\n"
                                + "            </div>\n"
                                + "                 <div class=\"jumbotron\">\n"
                                + "                    <h2>Ganti Foto Produk</h2>\n"
                                + "                                    <form enctype=\"multipart/form-data\" action=\"./simpan_perubahanPadaFotoProduk\" method=\"POST\">\n"
                                + "                                        <div class=\"panel-body\"><center><img src=\"./productImage_loader?idProduk_=" + prdct_details.getId_produk() + "\" class=\"img-responsive\" width=\"300\" height=\"250\" alt=\"Image\"></center></div>\n"
                                + "                                        <div class=\"form-group\">\n"
