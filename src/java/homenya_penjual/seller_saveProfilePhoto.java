...
@WebServlet(name = "seller_saveProfilePhoto", urlPatterns = {"/seller_saveProfilePhoto"})
public class seller_saveProfilePhoto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Part filePart;
        filePart = request.getPart("fotoToko");
        ...
        try {
            ...
            int idToko_int = Integer.parseInt(request.getParameter("idToko"));

            PreparedStatement PSeditphoto = conn.prepareStatement("UPDATE tabel_toko SET logo_toko=? WHERE id_toko=?");
            PSeditphoto.setBlob(1, inputStream);
            PSeditphoto.setInt(2, idToko_int);
            PSeditphoto.executeUpdate();
            conn.close();

            try {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Berhasil ganti foto/logo toko');");
            ...
            Logger.getLogger(seller_saveProfilePhoto.class.getName()).log(Level.SEVERE, null, ex);
