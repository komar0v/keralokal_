 ...
 * @author ASUS
 */
@WebServlet(name = "view_urusanPembayaran", urlPatterns = {"/view_urusanPembayaran"})
public class view_urusanPembayaran extends HttpServlet {
                ...
                try {
                    ...
                    try {
                        out.println("<!DOCTYPE html>\n"
                                ...
                                + "                "
                                + "                <div class=\"row\">\n"
                                + "                    <h2>Daftar Metode Bayar Tersedia</h2>\n"
                                ...
                                + "                    <tr>\n"
                                + "                        <th>#</th>"
                                + "                        <th style=\"width: 10%;\">ID Metode Bayar</th>\n"
                                + "                        <th style=\"width: 22%;\">Nama Metode Bayar</th>\n"
                                + "                        <th>Opsi</th>\n"
                                + "                    </tr>\n"
                                + "                </thead>"
                                + "         <tbody>");
                        for (int i = 0; i < payment.size(); i++) {
                            ...
                            out.println("<tr>"
                                    + "<td>" + urutan + "</td>"
                                    + "<td>" + payment.get(i).getId_paymentMethod() + "</td>"
                                    + "<td>" + payment.get(i).getNama_paymentMethod() + "</td>"
                                    + "<td>\n"
                                    + "    <a href=\"./viewdetail_urusanPembayaran?idMetodeBayar_=" + payment.get(i).getId_paymentMethod() + "\" class=\"view\" title=\"View\" data-toggle=\"tooltip\"><i class=\"material-icons\">remove_red_eye</i></a>"
                                    + "    <a href=\"./confirmhapusdata_urusanPembayaran?idMetodeBayar_=" + payment.get(i).getId_paymentMethod() + "\" class=\"delete\" title=\"Delete\" data-toggle=\"tooltip\"><i class=\"material-icons\">&#xE872;</i></a>\n"
                                    + "</td>"
                                    + "</tr>");
                        }
                        out.println("</table>\n"
