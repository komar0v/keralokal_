 ...
 * @author ASUS
 */
@WebServlet(name = "_urusanPembayaran", urlPatterns = {"/_urusanPembayaran"})
public class _urusanPembayaran extends HttpServlet {
            ...
            if (levelAkun.equals("admin")) {
                try {
                    out.println("<!DOCTYPE html>\n"
                            ...
                            + "                        <form class=\"form\" enctype=\"multipart/form-data\" action=\"./simpan_urusanPembayaran\" method=\"POST\" id=\"registrationForm\">\n"
                            + "\n"
                            + "                            <div class=\"form-group\">\n"
                            + "                                <div class=\"col-xs-6\">\n"
                            + "                                    <h4>Nama Perusahaan</h4>\n"
                            + "                                    <input type=\"text\" class=\"form-control\" name=\"nama_penyediajasabayar\" id=\"nama_depan\" required placeholder=\"ex : OVO, other banks\">\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "\n"
                            + "                            \n"
                            ...
                            + "                                    <input type=\"text\" class=\"form-control\" name=\"noHp_penyediajasabayar\" id=\"no_hp\" required placeholder=\"kode area - nomor\">\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "\n"
                            + "                            <div class=\"form-group\">\n"
                            ...
                            + "                                    <textarea rows=\"5\" type=\"text\" class=\"form-control\" name=\"alamat_penyediajasabayar\" required id=\"alamat\"> </textarea>\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "\n"
                            + "                            <div class=\"form-group\">\n"
                            ...
                            + "                                    <input type=\"file\" class=\"custom-file-input\" id=\"logo_payment\" name=\"logo_payment\" required accept=\"image/*\"/>\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + ""
                            + "                            <div class=\"form-group\">\n"
