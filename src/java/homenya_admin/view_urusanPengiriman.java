 ...
 * @author ASUS
 */
@WebServlet(name = "view_urusanPengiriman", urlPatterns = {"/view_urusanPengiriman"})
public class view_urusanPengiriman extends HttpServlet {
        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("admin")) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("SELECT id_kurir, nama_kurir FROM tabel_kurir");
                    ...
                    while (rs.next()) {
                        ...
                        OBJ_kurir dftr_kurir = new OBJ_kurir();
                        dftr_kurir.setId_kurir(rs.getInt("id_kurir"));
                        dftr_kurir.setNama_kurir(rs.getString("nama_kurir"));

                        kurir.add(dftr_kurir);
                    }
                    try {
                        out.println("<!DOCTYPE html>\n"
                            ...
                            + "                            <li><a href=\"./view_urusanToko\">Daftar Toko yang Tersedia</a></li>\n"
                                ...
                                + "                "
                                + "                <div class=\"row\">\n"
                                + "                    <h2>Daftar Kurir Pengiriman Tersedia</h2>\n"
                                ...
                                + "                    <tr>\n"
                                + "                        <th>#</th>\n"
                                + "                        <th style=\"width: 10%;\">ID Jasa Kirim</th>\n"
                                + "                        <th style=\"width: 22%;\">Nama Jasa Kirim</th>\n"
                                + "                        <th>Opsi</th>\n"
                                + "                    </tr>\n"
                                + "                </thead>"
                                + "         <tbody>");
                        for (int i = 0; i < kurir.size(); i++) {
                            ...
                            out.println("<tr>"
                                    + "<td>" + urutan + "</td>"
                                    + "<td>" + kurir.get(i).getId_kurir() + "</td>"
                                    + "<td>" + kurir.get(i).getNama_kurir() + "</td>"
                                    + "<td>\n"
                                    + "    <a href=\"./viewdetail_urusanPengiriman?idKurir_=" + kurir.get(i).getId_kurir() + "\" class=\"view\" title=\"View\" data-toggle=\"tooltip\"><i class=\"material-icons\">remove_red_eye</i></a>"
                                    + "    <a href=\"./confirmhapusdata_urusanPengiriman?idKurir_=" + kurir.get(i).getId_kurir() + "\" class=\"delete\" title=\"Delete\" data-toggle=\"tooltip\"><i class=\"material-icons\">&#xE872;</i></a>\n"
                                    + "</td>"
                                    + "</tr>");
                        }
                        out.println("</table>\n"
