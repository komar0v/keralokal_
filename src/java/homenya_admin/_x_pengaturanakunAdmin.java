 ...
 * @author ASUS
 */
@WebServlet(name = "_x_pengaturanakunAdmin", urlPatterns = {"/_x_pengaturanakunAdmin"})
public class _x_pengaturanakunAdmin extends HttpServlet {
        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("admin")) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("SELECT * FROM tabel_admin WHERE id_admin=?");
                    String idnyaadmin = request.getParameter("idAdmin_");
                    ps.setString(1, idnyaadmin);

                    ResultSet rs = ps.executeQuery();
                    if (rs.next()) {
                        admin_.setId_admin(rs.getString("id_admin"));
                        admin_.setNama_admin(rs.getString("nama_admin"));
                        admin_.setEmail_admin(rs.getString("email_admin"));
                        admin_.setUsername_admin(rs.getString("pass_admin"));
                    }
                    ...
                    try {
                        out.println("<!DOCTYPE html>\n"
                                ...
                                + "\n"
                                + "                    <li>\n"
                                + "                        <a href=\"#\"><i class=\"fa fa-fw fa-cogs\"></i> Pengaturan Akun</a>\n"
                                + "                    </li>\n"
                                + "                    <li>\n"
                                ...
                                + "                        <form class=\"form\" action=\"./_x_pengaturanakunAdminLakukanPerubahan\" method=\"POST\" id=\"registrationForm\">\n"
                                + "\n"
                                + "                            <div class=\"form-group\">\n"
                                + "                                <div class=\"col-xs-6\">\n"
                                + "                                    <h4>Nama Admin</h4>\n"
                                + "                                    <input type=\"text\" class=\"form-control\" name=\"nama_admin\" id=\"nama_depan\" placeholder=\"nama admin\" value=\"" + admin_.getNama_admin() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + "\n"
                                ...
                                + "                                <div class=\"col-xs-6\">\n"
                                + "                                    <h4>E-mail Admin</h4>\n"
                                + "                                    <input type=\"email\" class=\"form-control\" name=\"email_admin\" id=\"no_hp\" placeholder=\"contoh@mail.com\" value=\"" + admin_.getEmail_admin() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + "                            <div class=\"form-group\">\n"
                                ...
                                + "                                    <p>Jika ingin ganti password langsung ketik saja</p>\n"
                                + "                                    <input type=\"password\" class=\"form-control\" name=\"password_admin\" id=\"no_hp\" value=\"" + admin_.getPassword_admin() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + ""
                                + "                            <div class=\"form-group\">\n"
                                + "                                <div class=\"col-xs-6\">\n"
                                + "                                    <h4>ID Admin</h4>\n"
                                + "                                    <input type=\"text\" class=\"form-control\" name=\"id_admin\" readonly value=\"" + admin_.getId_admin() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + ""
