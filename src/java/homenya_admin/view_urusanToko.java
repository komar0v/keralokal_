 ...
 * @author ASUS
 */
@WebServlet(name = "view_urusanToko", urlPatterns = {"/view_urusanToko"})
public class view_urusanToko extends HttpServlet {
        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("admin")) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("SELECT id_toko, nama_toko FROM tabel_toko");
                    ResultSet rs = ps.executeQuery();

                    ArrayList<OBJ_toko> store_ = new ArrayList<OBJ_toko>();
                    int urutan = 0;
                    while (rs.next()) {

                        OBJ_toko dftr_toko = new OBJ_toko();
                        dftr_toko.setId_toko(rs.getInt("id_toko"));
                        dftr_toko.setNama_toko(rs.getString("nama_toko"));

                        store_.add(dftr_toko);
                    }
                    try {
                        out.println("<!DOCTYPE html>\n"
                            ...
                            + "                            <li><a href=\"./view_urusanToko\">Daftar Toko yang Tersedia</a></li>\n"
                                ...
                                + "                    <tr>\n"
                                + "                        <th>#</th>\n"
                                + "                        <th style=\"width: 10%;\">ID Toko</th>\n"
                                + "                        <th style=\"width: 22%;\">Nama Toko</th>\n"
                                + "                        <th style=\"width: 22%;\">Logo Toko</th>\n"
                                + "                        <th>Opsi</th>\n"
                                + "                    </tr>\n"
                                + "                </thead>"
                                + "         <tbody>");
                        for (int i = 0; i < store_.size(); i++) {
                            ...
                            out.println("<tr>"
                                    + "<td>" + urutan + "</td>"
                                    + "<td>" + store_.get(i).getId_toko() + "</td>"
                                    + "<td>" + store_.get(i).getNama_toko() + "</td>"
                                    + "<td><img src=\"./storeLogo_loader?idToko_=" + store_.get(i).getId_toko() + "\" width=\"90\" height=\"50\"/></td>"
                                    + "<td>\n"
                                    + "    <a href=\"./confirmhapusdata_urusanToko?idToko_=" + store_.get(i).getId_toko() + "\" class=\"delete\" title=\"Delete\" data-toggle=\"tooltip\"><i class=\"material-icons\">&#xE872;</i></a>\n"
                                    + "</td>"
                                    + "</tr>");
                        }
                        out.println("</table>\n"
