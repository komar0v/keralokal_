 ...
 * @author ASUS
 */
@WebServlet(name = "seller_kotakMasuk_diterima", urlPatterns = {"/seller_kotakMasuk_diterima"})
public class seller_kotakMasuk_diterima extends HttpServlet {
        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("seller")) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("SELECT * FROM tabel_kotak_masuk WHERE request_ke=? AND status_request = 'diterima' ");
                    ...
                    try {
                        out.println("<!DOCTYPE html>\n"
                                ...
                                + "                        <li class=\"active\"><a href=\"./seller_kotakMasuk_diterima\" >Diterima</a>\n"
                                + "                        <li ><a href=\"./seller_kotakMasuk_ditolak\" >Ditolak</a>\n"
                                + "                        </li>\n"
                                + "                    </ul>\n"
                                + "\n"
