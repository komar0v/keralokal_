...
import homenya_admin.simpan_urusanPengiriman;
...
@WebServlet(name = "simpan_perubahanPadaFotoProduk", urlPatterns = {"/simpan_perubahanPadaFotoProduk"})
public class simpan_perubahanPadaFotoProduk extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int idProduk_int = Integer.parseInt(request.getParameter("idProduk"));

            PreparedStatement PSeditphoto = conn.prepareStatement("UPDATE tabel_produk SET foto_produk=? WHERE product_id=?");
            PSeditphoto.setBlob(1, inputStream);
            PSeditphoto.setInt(2, idProduk_int);
            PSeditphoto.executeUpdate();
            conn.close();

            try {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Berhasil ganti foto produk');");
            ...
            Logger.getLogger(simpan_perubahanPadaFotoProduk.class.getName()).log(Level.SEVERE, null, ex);
