 ...
 * @author ASUS
 */
@WebServlet(name = "_x_pengaturanakunAdminLakukanPerubahan", urlPatterns = {"/_x_pengaturanakunAdminLakukanPerubahan"})
public class _x_pengaturanakunAdminLakukanPerubahan extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        OBJ_admin admin_ = new OBJ_admin();
        admin_.setId_admin(request.getParameter("id_admin"));
        admin_.setNama_admin(request.getParameter("nama_admin"));
        admin_.setEmail_admin(request.getParameter("email_admin"));
        admin_.setPassword_admin(request.getParameter("password_admin"));
        
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn = db_connection.connect_to_Db();
            
            PreparedStatement prpEdit = conn.prepareStatement("UPDATE tabel_admin SET nama_admin=?, email_admin=?, pass_admin=? WHERE id_admin=?");
            prpEdit.setString(1, admin_.getNama_admin());
            prpEdit.setString(2, admin_.getEmail_admin());
            prpEdit.setString(3, admin_.getPassword_admin());
            prpEdit.setString(4, admin_.getId_admin());
