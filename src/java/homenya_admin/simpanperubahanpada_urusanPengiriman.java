 ...
 * @author ASUS
 */
@WebServlet(name = "simpanperubahanpada_urusanPengiriman", urlPatterns = {"/simpanperubahanpada_urusanPengiriman"})
public class simpanperubahanpada_urusanPengiriman extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int idKurir = Integer.parseInt(request.getParameter("id_jasaKirim"));
        kurir.setId_kurir(idKurir);
        ...
        try{
            ...
            PreparedStatement prpEdit = conn.prepareStatement("UPDATE tabel_kurir SET nama_kurir=?, notel_kurir=?, alamatkantor_kurir=? WHERE id_kurir=?");
            prpEdit.setString(1, kurir.getNama_kurir());
            prpEdit.setString(2, kurir.getNotel_kurir());
            prpEdit.setString(3, kurir.getAlamatkantor_kurir());
            prpEdit.setInt(4, kurir.getId_kurir());
            prpEdit.executeUpdate();
            conn.close();
            
            try {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Berhasil Edit Layanan Kirim');");
                out.println("location='./view_urusanPengiriman';");
                out.println("</script>");
            } finally {
                out.close();
            }
