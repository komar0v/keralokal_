 ...
 * @author ASUS
 */
@WebServlet(name = "_urusanPengiriman", urlPatterns = {"/_urusanPengiriman"})
public class _urusanPengiriman extends HttpServlet {
            ...
            if (levelAkun.equals("admin")) {
                try {
                    out.println("<!DOCTYPE html>\n"
                            ...
                            + "\n"
                            + "                    <div class=\"row\">\n"
                            + "                        <h2>Tambah Jasa Kurir Pengirim</h2>\n"
                            + "                        <form class=\"form\" enctype=\"multipart/form-data\" action=\"./simpan_urusanPengiriman\" method=\"POST\" id=\"registrationForm\">\n"
                            + "\n"
                            + "                            <div class=\"form-group\">\n"
                            + "                                <div class=\"col-xs-6\">\n"
                            + "                                    <h4>Nama Perusahaan</h4>\n"
                            + "                                    <input type=\"text\" class=\"form-control\" name=\"nama_jasaKirim\" id=\"nama_depan\" required placeholder=\"ex : JNE, TIKI\">\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "\n"
                            + "                            \n"
                            ...
                            + "                                    <input type=\"text\" class=\"form-control\" name=\"noHp_jasaKirim\" id=\"no_hp\" required placeholder=\"kode area - nomor\">\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "\n"
                            + "                            <div class=\"form-group\">\n"
                            ...
                            + "                                    <textarea rows=\"5\" type=\"text\" class=\"form-control\" name=\"alamat_jasakirim\" required id=\"alamat\"> </textarea>\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "\n"
                            + "                            <div class=\"form-group\">\n"
                            ...
                            + "                                    <input type=\"file\" class=\"custom-file-input\" id=\"logo_shipping\" name=\"logo_shipping\" required accept=\"image/*\"/>\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + ""
                            + "                            <div class=\"form-group\">\n"
