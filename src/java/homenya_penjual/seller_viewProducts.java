 ...
 * @author ASUS
 */
@WebServlet(name = "seller_viewProducts", urlPatterns = {"/seller_viewProducts"})
public class seller_viewProducts extends HttpServlet {
        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("seller")) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("SELECT product_id, nama_produk FROM tabel_produk WHERE inserted_by=?");
                    ...
                    try {
                        out.println("<!DOCTYPE html>\n"
                                ...
                                + "                        <li class=\"\"><a href=\"./seller_urusanProduk\" data-toggle=\"tab\">Tambah Produk</a>\n"
                                + "                        </li>\n"
                                + "                        <li class=\"active\"><a href=\"#\" data-toggle=\"tab\">Lihat Daftar Produk</a>\n"
                                + "                        </li>\n"
                                + "                    </ul>\n"
                                + "\n"
                        ...
                        for (int i = 0; i < products.size(); i++) {
                            out.println("<div class=\"col-sm-4\">\n"
                                    ...
                                    + "        <div class=\"panel-footer\" onclick=\"location.href='./seller_viewProductDetails?idProduk_="+products.get(i).getId_produk()+"';\" style=\"cursor: pointer;\">Lihat Detail</div>\n"
                                    + "      </div>\n"
                                    + "    </div>");
                        }
