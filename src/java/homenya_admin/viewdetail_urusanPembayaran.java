 ...
 * @author ASUS
 */
@WebServlet(name = "viewdetail_urusanPembayaran", urlPatterns = {"/viewdetail_urusanPembayaran"})
public class viewdetail_urusanPembayaran extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cookies != null) {
            ...
            if (levelAkun.equals("admin")) {
                try {
                    OBJ_metodepembayaran payment_ = new OBJ_metodepembayaran();
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection conn = db_connection.connect_to_Db();

                    PreparedStatement ps = conn.prepareStatement("SELECT * FROM tabel_metodebayar WHERE id_pymntmthd=?");
                    String idnyametodebayar = request.getParameter("idMetodeBayar_");
                    ps.setString(1, idnyametodebayar);

                    ResultSet rs = ps.executeQuery();
                    if (rs.next()) {
                        payment_.setId_paymentMethod(rs.getInt("id_pymntmthd"));
                        payment_.setNama_paymentMethod(rs.getString("nama_pymntmthd"));
                        payment_.setNotel_paymentMethod(rs.getString("notel_pymntmthd"));
                        payment_.setAlamatkantor_paymentMethod(rs.getString("alamatkantor_pymntmthd"));
                    }
                    ...
                    try {
                        out.println("<!DOCTYPE html>\n"
                            ...
                            + "                            <li><a href=\"./view_urusanToko\">Daftar Toko yang Tersedia</a></li>\n"
                                ...
                                + "\n"
                                + "                    <div class=\"row\">\n"
                                + "                        <h2>Detail Penyedia Metode Pembayaran</h2>\n"
                                + "                        <form class=\"form\" action=\"./simpanperubahanpada_urusanPembayaran\" method=\"POST\" id=\"registrationForm\">\n"
                                + "\n"
                                + "                            <div class=\"form-group\">\n"
                                + "                                <div class=\"col-xs-6\">\n"
                                + "                                    <h4>Nama Perusahaan</h4>\n"
                                + "                                    <input type=\"text\" class=\"form-control\" name=\"nama_penyediajasabayar\" id=\"nama_depan\" placeholder=\"ex : OVO, other banks\" value=\"" + payment_.getNama_paymentMethod() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + "                            \n"
                                ...
                                + "                                    <input type=\"text\" class=\"form-control\" name=\"nohp_penyediajasabayar\" id=\"no_hp\" placeholder=\"kode area - nomor\" value=\"" + payment_.getNotel_paymentMethod() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + "                            <div class=\"form-group\">\n"
                                ...
                                + "                                    <textarea rows=\"5\" type=\"text\" class=\"form-control\" name=\"alamat_penyediajasabayar\" id=\"alamat\">" + payment_.getAlamatkantor_paymentMethod() + "</textarea>\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + "                            <div class=\"form-group\">\n"
                                + "                                <div class=\"col-xs-6\">\n"
                                + "                                    <h4>ID Metode Bayar</h4>\n"
                                + "                                    <input type=\"text\" class=\"form-control\" name=\"id_penyediajasabayar\" id=\"idJasaKurir\" readonly value=\"" + payment_.getId_paymentMethod() + "\">\n"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + "\n"
                                + "                            <div class=\"form-group\">\n"
                                + "                                <div class=\"col-xs-6\">\n"
                                + "                                    <br><img src=\"./paymentLogo_loader?idMetodeBayar_=" + payment_.getId_paymentMethod() + "\" width=\"220\" height=\"130\"/>"
                                + "                                </div>\n"
                                + "                            </div>\n"
                                + ""
                                + "                            <div class=\"form-group\">\n"
